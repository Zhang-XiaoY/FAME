...
class cxb_conv2d(nn.Conv2d):
    ...
    def forward(self,input):
        ...
        pos_result=F.conv2d(input,pos_conv_weight,self.bias,self.stride,self.padding)
        neg_result=F.conv2d(input=input,weight=neg_conv_weight,bias=None,\
